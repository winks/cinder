	...
	public void createFieldEditors() {
		...
		addField(
			new BooleanFieldEditor(
				CinderPrefTools.P_BOOLEAN,
				"&An example of a boolean preference - cinder",
				getFieldEditorParent()));

		addField(
			new RadioGroupFieldEditor(
				CinderPrefTools.P_CHOICE,
				"An example of a multiple-choice preference - cinder",
				1,
		...
		addField(
				new StringFieldEditor(	
					CinderPrefTools.P_STRING+"_line", 
					"&line number:", 
					getFieldEditorParent())
			);
	}
